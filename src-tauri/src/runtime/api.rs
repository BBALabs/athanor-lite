...
//! on a stable port with a persistent bearer key — an OpenAI-compatible
//! endpoint for editors, automation tools, and scripts, pointed at
//! `http://127.0.0.1:<port>/v1` and surviving restarts.
